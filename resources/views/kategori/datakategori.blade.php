                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Kategori Barang</div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    <h4><em>DATA KATEGORI</em></h4>
                                    <hr>
                                    <a href="/tambahkategori" class="btn btn-success mb-10">Tambah Data Kategori +</a>
                                    <br></br>
                                    <div class="row" > 
                                            ...
                                            <table class="table table-striped table-bordered mb-0" id="example">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/tampildatakategori/{{ $row->id }}" class="btn btn-warning"><i class="fa-sharp fa-solid fa-pen-to-square"></i></a>
