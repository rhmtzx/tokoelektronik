  <nav class="navbar navbar-expand">
        ...
        <div>
          <p class="info">
            <h5>
              <a href="welcome" class="d-block" style="color: #000000; align-items: center; display: flex; margin-top: 12px;">
                Hello {{ Auth::user()->name }}, Welcome To Admin Page
              </a>
            </h5>
          </p>
        </div>
              ...
              <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-bs-toggle="dropdown">
                <div class="d-flex user-box align-items-center">
                  <div class="user-info">
                    ...
                    <p class="designattion mb-0"><em>Admin</em></p>
                  </div>
