							...
							<div class="col-xl-6">
								<div class="card-body p-md-5">
									<div class="text-center">
										<img src="{{asset('admin/assets/images/rlogo.png')}}" width="80" alt="">
										...
										<div class="form-body">
											<form class="row g-3" action="/registeruser" method="post">
												...
												<div class="col-sm-12">
													...
													<input type="text" class="form-control" name="name" id="inputFirstName" placeholder="Input Name">
												</div>
												
												<!-- <div class="col-sm-6">
													<label for="inputLastName" class="form-label">Last Name</label>
													<input type="text" class="form-control" name="name" id="inputLastName" placeholder="Deo">
												</div> -->
												<div class="col-12">
													<label for="inputEmailAddress" class="form-label">Email Address</label>
													<input type="email" class="form-control" name="email" id="inputEmailAddress" placeholder="Input Email">
												</div>
												@error('email')
												...
												<div class="col-12">
													...
													<div class="input-group" id="show_hide_password">
														<input type="password" class="form-control border-end-0" name="password" id="inputChoosePassword" placeholder="Create Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
													</div>
												</div>
												@error('password')
												<div class="text-danger">{{ $message }}
