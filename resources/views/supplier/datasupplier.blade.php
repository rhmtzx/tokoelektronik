          ...
          <div class="card-body">
            <div class="container">
              ...
              <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Data Supplier</div>
                    <div class="ps-3">
                ...
                <div class="card">
                  <div class="card-body">
                    <div>
                      <h4><em>DATA SUPPLIER</em></h4>
                      <hr>
                      <a href="/tambahsupplier" class="btn btn-success mb-10">Tambah Data Supplier +</a>
                      <br></br>
                      <div class="row" > 
                          ...
                          <table class="table table-striped table-bordered mb-0" id="example">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <a href="/tampildatasupplier/{{ $row->id }}" class="btn btn-warning"><i class="fa-sharp fa-solid fa-pen-to-square"></i></a>
  ...
  $('.delete').click(function() {
    ...
    .then((willDelete) => {
      if (willDelete) {
        ...
        swal("Data Supplier Berhasil Di Hapus", {
          icon: "success",
        });
      } else {
        swal("Data Supplier Gagal Di Hapus");
      }
    });
  });
</script>
